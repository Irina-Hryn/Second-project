const DOM = {
    ...
    wrapIn: document.querySelector('.wrapIn'),
    wrapUp: document.querySelector('.wrapUp'),
    registr: document.querySelector('.registr'),
    filmsArea: document.querySelector('.filmsArea'),
    wrapRegistr: document.querySelector('.wrapRegistr'),
    navigationRight: document.querySelector('.navigationRight')
}